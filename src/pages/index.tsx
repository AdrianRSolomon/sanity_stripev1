...
const Home: React.FC<HomeProps> = ({ categories, products }) => {
  return (
    <>
      ...
      <section className="bg-white dark:bg-gray-900 my-6">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm text-center">
            ...
            Don't miss out on our exclusive deals and promotions! Sign up for our newsletter to stay up-to-date on the latest sales and discounts. Plus, enjoy fast and reliable shipping to get your new tech in your hands as soon as possible.
      ...
      <section className="bg-white dark:bg-gray-100" id='contact'>
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 lg:grid-cols-2">
            <div>
              ...
              <div className="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900">
                ...
                Samsung has been making waves in the tech industry with their latest release - the Galaxy Buds.
                </p>
                <p className="mt-3 text-sm text-blue-500">21 August 2021</p>
              </div>
            </div>
            <div>
              <img
              ...
              <div className="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900">
                ...
                <p className="mt-3 text-sm text-gray-500 dark:text-gray-300 md:text-sm">
                The release of the iPhone 14 is highly anticipated by Apple fans all around the world. Rumors and leaks have been swirling around about what new features and upgrades we can expect from the upcoming device.
                </p>
                <p className="mt-3 text-sm text-blue-500">20 October 2022</p>
              </div>
            </div>
          </div>
        </div>
